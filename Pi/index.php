...
//      "UpTime" => trim(substr(shell_exec('uptime'),strpos(shell_exec('uptime'), 'up')+2, strpos(shell_exec('uptime'), ',')-strpos(shell_exec('uptime'), 'up')-2)),
        ...
        "Temperature" => shell_exec('sudo python temperature.py|tr -d \'\n\''),
...
function Uptime() {
        $curDate = shell_exec('date | tr -d \'\n\'');
        $curUptime = shell_exec('uptime -p | tr -d \'\n\'');
    return $curUptime .' '. $curDate;
}
...
<form method="post">
        ...
        <div style="border: 2px dashed #969696; background-color: #D0D0D0;">
                ...
                <br/>
                <div class="center" style="transform: scale(1.0); -webkit-transform: scale(1.0); margin-top:6px; width:230px;border:1px solid; padding:3px;"><input type="text" name="MainPin" value="4" maxlength="2" size="2">&nbsp;&nbsp;&nbsp;Main Pin # in BCM</di>
...
<div>
<a target="_blank" href="https://community.smartthings.com/t/raspberry-pi-to-php-to-gpio-to-relay-to-gate-garage-trigger/43335">Project on SmartThings Community
</a></br>
